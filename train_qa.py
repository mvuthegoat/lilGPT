  ...
  for i, mapping_pos in enumerate(offset_mapping):
    ...
    if len(answer['text']) == 0:
      ...
      if context_start_char > answer_start_char or context_end_char < answer_end_char:
        ...
        while answer_start_token < len(mapping_pos) and mapping_pos[answer_start_token][0] <= answer_start_char:
        ...
        while answer_end_token >= 0 and mapping_pos[answer_end_token][1] >= answer_end_char:
          answer_end_token -= 1
...
pre_trained_ckpt = torch.load('/home/minhvn/workspace/llm/my_model/checkpoints/ckpt-2000.pt')
